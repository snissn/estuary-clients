...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyDIServerCodegen", date = "2022-11-12T01:09:17.790Z[GMT]")public class CollectionsApi  {
...
,@Parameter(in = ParameterIn.PATH, description = "coluuid",required=true) @PathParam("coluuid") String coluuid
,@Context SecurityContext securityContext)
    throws NotFoundException {
